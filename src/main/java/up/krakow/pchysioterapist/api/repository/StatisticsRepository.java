...
public interface StatisticsRepository  extends JpaRepository<Statistics, Integer> {
    ...
    int getNumberOfAppointments(LocalDate startDate, LocalDate endDate);
    ...
    double getIncome(LocalDate startDate, LocalDate endDate);
    ...
    int getNumberOfMassagesByType(LocalDate startDate, LocalDate endDate, String appointmentType);
